...
const Contact = () => {//this code is from emailjs
    const form = useRef();
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_9vxtjf3', 'template_h5hs1j3', form.current, {
        publicKey: '62U-pZEuVNxGXDR4i',
      })
      e.target.reset()
  };
  return (
            ...
            <div className="contact_content">
                ...
                <div className="contact_info">
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">thevindukevin@gmail.com</span>
            ...
            <div className="contact_content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact_form">
                    ...
                    <div className="contact_form-div">
                        ...
                        <textarea name="massage" cols="30" rows="10" className="contact_form-input" placeholder="Write your message..."></textarea>
                    </div>
